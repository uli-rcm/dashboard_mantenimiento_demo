...
# installed.
TCL_PREFIX='g:/Mi unidad/Blatt/Mantenimiento/8 Presentación Metodología de Monitoreo/Demo/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='g:/Mi unidad/Blatt/Mantenimiento/8 Presentación Metodología de Monitoreo/Demo/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='g:/Mi unidad/Blatt/Mantenimiento/8 Presentación Metodología de Monitoreo/Demo/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ig:/Mi unidad/Blatt/Mantenimiento/8 Presentación Metodología de Monitoreo/Demo/.conda\Library\include'
...
TCL_PACKAGE_PATH='g:/Mi unidad/Blatt/Mantenimiento/8 Presentación Metodología de Monitoreo/Demo/.conda\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Lg:/Mi unidad/Blatt/Mantenimiento/8 Presentación Metodología de Monitoreo/Demo/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='g:/Mi unidad/Blatt/Mantenimiento/8 Presentación Metodología de Monitoreo/Demo/.conda\Library\lib\tclstub86.lib'
